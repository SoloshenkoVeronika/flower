                    ...
                    <section class="main">
                        ...
                        <form:form action="${addAction}" commandName="composition" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <form:input path="name" pattern="(.[a-zA-Zа-яА-Я\s,ёЁ_-]*)" title="Используйте латинские или русские символы." class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <form:input path="pack" pattern="(.[a-zA-Zа-яА-Я\s,ёЁ_-]*)" title="Используйте латинские или русские символы." class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">

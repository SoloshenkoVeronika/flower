                        ...
                        <c:if test="${!empty listDecorations}">
                            ...
                            <c:forEach items="${listDecorations}" var="decoration">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <c:url var="addAction" value="/order/addDecorationToCustomerBouquet"/>
                                        <form:form action="${addAction}" modelAttribute="decorationCustomerBouquet" class="form-horizontal">
                                            ...
                                            <div class="fontbut">
                                                ...
                                                <input onclick="return openModal('${decoration.name}', '${decoration.amount}' , 'input${j}')"

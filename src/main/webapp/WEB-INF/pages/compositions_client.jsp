            ...
            <div class="row otstup">
                <div class="col-md-12">
                    <h1 class="h2 page-header"
                        ...
                        text-align: center;"> Композиции</h1>
                    <section class="main">
                            ...
                            <c:forEach items="${listCompositions}" var="composition">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <br>
                                        <div class="fontchar">
                                            <div class="namechar">Состав:   </div> <div class="charact">${composition.composition}</div><br>
                                            <div class="namechar">Упаковка:   </div> <div class="charact">${composition.pack} см.</div><br>
                                            <div class="namechar">Цена:     </div> <div class="charact">${composition.price}</div><br>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <c:url var="addAction" value="/order/addComposition"/>
                                        <form:form action="${addAction}" modelAttribute="compositionOrder" class="form-horizontal">
                                            ...
                                            <div class="fontbut">
                                                <form:hidden path="compositionId" value="${composition.id}"/>

                                                <input onclick="return openModal('${composition.name}', '${composition.amount}' , 'input${j}')"
